...
\fancyhead[CE]{\athiti\fontsize{7}{1}\selectfont \hspace{0.25in}{\fontseries{sb}\selectfont WORLDEND}: \textof[m]{What Do You Do at the End of the World? Are You Busy? Will You Save Us?,} \textof[el]{Vol.\volumeNumber}}
...
\newcommand{\insertInTextImage}[1]{\afterpage{\insertSingleImage{#1}\newpage}}
...
\newcommand{\creditsPage}[4]{
...

  {
    ...
    {\fontseries{b}\selectfont WORLDEND:} {\fontseries{md}\selectfont WHAT DO YOU DO AT THE END OF THE WORLD?
  ...
  SHUMATSU NANI SHITEMASUKA? ISOGASHIIDESUKA? SUKUTTEMORATTEIIDESUKA? Vol.~\volumeNumber \\
  ©#2 Akira Kareno, ue \\
  ...
  First Yen On Edition: November 2019
  ...
  Identifiers: LCCN 2018016690 | ISBN 9781975326876 (v. 1 : pbk.) | ISBN 9781975326883 (v. 2 : pbk.) | ISBN 9781975326913 (v. 3 : pbk.) | ISBN 9781975326937 (v. 4 : pbk.) | ISBN 9781975326951 (v. 5 : pbk.) \\
  Classification: LCC PZ7.1.K364 Wo 2018 | DDC [Fic]—dc23 \\
  LC record available at https://lccn.loc.gov/2018016690

  ISBNs: #3 (paperback) \\
  \hphantom{ISBNs: }978-1-9753-2696-8 (ebook)

  This print edition is reproduced by the WorldEnd Formatting Project. \\
